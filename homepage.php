    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      <div class="col">
        <div class="card shadow-sm">
          ...
          <a href="medicine.php?m_cat=Antibiotics"><img style="height: 225px; width: 360px;" src="images/antibiotic.jpeg" alt="image"></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <a href="medicine.php?m_cat=Antiseptic"><img style="height: 225px; width: 360px;" src="images/antiseptic.jpeg" alt="image"></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <a href="medicine.php?m_cat=Antipyrtics"><img style="height: 225px; width: 360px;" src="images/antipyrtic.jpeg" alt="image"></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <a href="medicine.php?m_cat=Mood_stabilizers"> <img style="height: 225px; width: 360px;" src="images/mood_stabilizers.jpeg" alt="image"></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <a href="medicine.php?m_cat=Stimulant"> <img style="height: 225px; width: 360px;" src="images/stimulant.jpeg" alt="image"></a>
      ...
      <div class="col">
        <div class="card shadow-sm">
          ...
          <a href="medicine.php?m_cat=Analgesic"><img style="height: 225px; width: 360px;" src="images/Analgesic.jpeg" alt="image"></a>
