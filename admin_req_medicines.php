...
if (isset($_GET['unapprove'])) {
    ...
    $query = "UPDATE order_list SET order_status = 'UnApprove' WHERE order_med_Id={$medValueId}";
    $update_order_status = mysqli_query($conn, $query);
}
...
<form action="" method="post">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <tr>
                <?php
                $query = "SELECT * FROM medicines WHERE med_requestedQuant != 0 ORDER BY med_id DESC";
